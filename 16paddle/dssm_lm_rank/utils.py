...
def build_dict(data_file,
    ...
    :param cutoff_word_fre: if cutoff_thd is set, words whose frequencies are less
    ...
    :param insert_extra_words: extra keys defined by users that added into the word
        dictionary, ususally these keys include <unk>, start and ending marks
    :type insert_extra_words: list
    """
